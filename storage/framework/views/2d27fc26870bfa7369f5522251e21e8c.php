...
<body style="background: linear-gradient(135deg, #071c4d 0%, #123a8c 100%); min-height: 100vh;">
    <div class="d-flex align-items-center justify-content-center py-5" style="min-height: 100vh;">
        <div style="width: 100%; max-width: 540px;" class="px-3">
            <div class="text-center mb-4">
                <a href="<?php echo e(route('public.home')); ?>">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Altura Workforce Solutions" style="height: 64px; border-radius: 12px;">
                </a>
            </div>
            ...
            <p class="text-center text-white-50 small mt-4 mb-0">
                &copy; <?php echo e(date('Y')); ?> Altura Workforce Solutions — Where Talent Reaches New Heights
            </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\wamp64\www\altura-workforce\resources\views/layouts/guest.blade.php ENDPATH**/ ?>