<x-employer-layout title="Invoice Details">
    ...
    <a href="{{ route('employer.invoices.index') }}" class="text-decoration-none small mb-3 d-inline-block">← Back to Invoices</a>
    ...
    <div class="card stat-card p-4 mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
            <div>
                ...
                @if($invoice->jobApplication)
                    <p class="text-secondary small mb-0">{{ $invoice->jobApplication->jobPosting->title }}</p>
                @endif
            </div>
            <a href="{{ route('employer.invoices.download', $invoice) }}" class="btn btn-outline-secondary btn-sm">
        ...
        @if($invoice->balance > 0)
            <div class="col-lg-6" id="pay">
                <div class="card stat-card p-4">
                    ...
                    <form method="POST" action="{{ route('employer.invoices.payments.store', $invoice) }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="reference" class="form-control" placeholder="e.g. bank transfer reference">
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 {{ !$loop->last ? 'border-bottom' : '' }}">
                        ...
                        <div class="text-end">
                            ...
                            @if($payment->status === 'confirmed')
                                <a href="{{ route('employer.payments.receipt', $payment) }}" class="d-block small mt-1">Receipt</a>
                            @endif
                        </div>
                    </div>
                @empty
