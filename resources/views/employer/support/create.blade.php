<x-employer-layout title="Raise a Ticket">
    ...
    <div class="card stat-card p-4" style="max-width: 640px;">
        <form method="POST" action="{{ route('employer.support.store') }}">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <select name="category" class="form-select" required>
                        @foreach(['Worker Requests', 'Candidates', 'Job Postings', 'Documents', 'Payments', 'Job Offers', 'Other'] as $category)
            ...
            <a href="{{ route('employer.support.index') }}" class="btn btn-light">Cancel</a>
        </form>
    </div>
