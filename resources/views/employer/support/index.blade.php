<x-employer-layout title="Support">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('employer.support.create') }}" class="btn btn-primary">+ Raise Ticket</a>
    </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3">
            <div class="card stat-card p-3 h-100 text-center">
                ...
                <a href="{{ route('employer.support.create') }}" class="small">Create Ticket</a>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    @forelse($tickets as $ticket)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('employer.support.show', $ticket) }}" class="btn btn-sm btn-outline-primary">View</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-secondary py-5">
                                No support tickets yet. <a href="{{ route('employer.support.create') }}">Raise one →</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
