<x-job-seeker-layout title="Payments">
    ...
    <div class="card stat-card p-3 mb-4">
        ...
        @elseif($summary['balance'] > 0)
            <div class="text-center mt-3">
                <a href="{{ route('job-seeker.invoices.index') }}" class="btn btn-primary btn-sm">Pay Outstanding Balance →</a>
            </div>
        @endif
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                @if($payment->status === 'confirmed')
                                    <a href="{{ route('job-seeker.payments.receipt', $payment) }}" class="btn btn-sm btn-outline-secondary">View</a>
                                @else
