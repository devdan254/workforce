<x-job-seeker-layout title="Resources">

    <h2 class="h4 fw-semibold mb-1" style="font-family:'Poppins',sans-serif;color:#082159;">Resources</h2>
    <p class="text-secondary mb-4">Guides and checklists to help you land — and settle into — your next job abroad.</p>
                        ...
                        <div class="card stat-card p-3 h-100 d-flex flex-column">
                            ...
                            <div class="mt-auto pt-2">
                                @if($resource->file_path)
                                    <a href="{{ route('job-seeker.resources.download', $resource) }}" class="btn btn-sm btn-outline-primary w-100">
