<x-job-seeker-layout title="Invoices">
                ...
                <tbody>
                    @forelse($invoices as $invoice)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('job-seeker.invoices.show', $invoice) }}" class="btn btn-sm btn-outline-primary">View</a>
                                <a href="{{ route('job-seeker.invoices.download', $invoice) }}" class="btn btn-sm btn-outline-secondary">PDF</a>
                                @if($invoice->status !== 'paid')
                                    <a href="{{ route('job-seeker.invoices.show', $invoice) }}#pay" class="btn btn-sm btn-primary">Pay Now</a>
                                @endif
                            </td>
                        </tr>
                    @empty
