<x-job-seeker-layout title="Invoice Details">
    ...
    <a href="{{ route('job-seeker.invoices.index') }}" class="text-decoration-none small mb-3 d-inline-block">← Back to Invoices</a>
    ...
    <div class="card stat-card p-4 mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
            ...
            <a href="{{ route('job-seeker.invoices.download', $invoice) }}" class="btn btn-outline-secondary btn-sm">
        ...
        @if($invoice->balance > 0)
            <div class="col-lg-6" id="pay">
                <div class="card stat-card p-4">
                    ...
                    <form method="POST" action="{{ route('job-seeker.invoices.payments.store', $invoice) }}">
                        @csrf
                        <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 {{ !$loop->last ? 'border-bottom' : '' }}">
                        ...
                        <div class="text-end">
                            ...
                            @if($payment->status === 'confirmed')
                                <a href="{{ route('job-seeker.payments.receipt', $payment) }}" class="d-block small mt-1">Receipt</a>
                            @endif
                        </div>
                    </div>
                @empty
