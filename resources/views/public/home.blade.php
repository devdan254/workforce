<x-public-layout title="Altura Workforce Solutions | Work Abroad, Study Abroad, Visa Support & Hire Talent" :meta-description="'Altura Workforce Solutions connects African talent, students and employers with international job placements, study abroad programs, visa support and skilled workforce recruitment.'">

<!-- ============ HERO SLIDER ============ -->
<section class="hero-slider">
  <div class="slide active" style="background-image:url('{{ asset('assets/images/bg-2.jpg') }}');">
    <div class="slide-content"><div class="container"><div class="slide-inner">
      ...
      <div class="hero-buttons">
        <a href="{{ route('public.jobs.index') }}" class="btn btn-primary">Start your Journey <i class="fa-solid fa-arrow-right"></i></a>
      </div>
      <div class="hero-buttons-secondary">
        <a href="{{ route('public.study-abroad.index') }}">Study Abroad</a>
        <a href="{{ route('public.hire') }}">Hire Talent</a>
        <a href="{{ route('public.visa') }}">Visa Support</a>
      </div>
    </div></div></div>
  </div>
  <div class="slide" style="background-image:url('{{ asset('assets/images/bg-4.jpg') }}');">
    <div class="slide-content"><div class="container"><div class="slide-inner">
      <span class="hero-mini">Altura Workforce Solutions</span>
...
<section class="section bg-white">
  <div class="container">
    ...
    <div class="lookingfor-grid reveal-stagger">
      <a href="{{ route('public.jobs.index') }}" class="lf-card reveal">
      ...
      <a href="{{ route('public.study-abroad.index') }}" class="lf-card reveal">
      ...
      <a href="{{ route('public.visa') }}" class="lf-card reveal">
      ...
      <a href="{{ route('public.hire') }}" class="lf-card reveal">
  ...
  <div class="container">
    <div class="about-split">
      ...
      <div class="about-copy reveal">
        ...
        <a href="{{ route('public.about') }}" class="btn btn-outline-navy">Discover Our Story <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="services-grid reveal-stagger">
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.jobs.index') }}" class="service-link">Apply Now <i class="fa-solid fa-arrow-right"></i></a>
      </div>
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.study-abroad.index') }}" class="service-link">Apply Now <i class="fa-solid fa-arrow-right"></i></a>
      </div>
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.visa') }}" class="service-link">Apply for VISA <i class="fa-solid fa-arrow-right"></i></a>
      </div>
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.hire') }}" class="service-link">Request for Workers <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div data-tabs>
          ...
          @forelse($featuredJobs as $job)
            <div class="card job-card reveal">
              ...
              <div class="job-card-body">
                <h3>{{ $job->title }}</h3>
                <p class="job-desc">{{ \Illuminate\Support\Str::limit($job->description, 110) }}</p>
                <div class="job-card-salary">
                  {{ $job->currency }} {{ number_format($job->salary_min, 0) }}@if($job->salary_max) – {{ number_format($job->salary_max, 0) }}@endif / Month
                </div>
      ...
      <div data-tab-panel="study">
        <div class="jobs-grid reveal-stagger">
          @forelse($featuredStudyPostings as $posting)
            <div class="card job-card reveal">
              <div class="job-card-img">
              ...
              <div class="job-card-body">
                ...
                <p class="job-desc">{{ \Illuminate\Support\Str::limit($posting->description, 110) }}</p>
                <a href="{{ route('public.study-abroad.show', $posting) }}" class="btn btn-navy btn-block">Learn More</a>
              </div>
            </div>
          @empty
    ...
    <div class="text-center mt-7"><a href="{{ route('public.jobs.index') }}" class="btn btn-outline-navy">View All Opportunities <i class="fa-solid fa-arrow-right"></i></a></div>
  </div>
</section>
...
<section class="section bg-tint">
  <div class="container">
    ...
    <div class="team-grid reveal-stagger">
      <div class="team-card card reveal"><div class="team-avatar"><img src="{{ asset('assets/images/teams/gabriel.jpg') }}" alt="Gabriel Okumu Oloo" class="team-avatar-img"></div><h3>Gabriel Okumu Oloo</h3><div class="team-role">Managing Director</div></div>
      <div class="team-card card reveal"><div class="team-avatar"><img src="{{ asset('assets/images/teams/sauda.jpg') }}" alt="Sauda Asmin Rashid" class="team-avatar-img"></div><h3>Sauda Asmin Rashid</h3><div class="team-role">Finance Officer</div></div>
      <div class="team-card card reveal"><div class="team-avatar"><img src="{{ asset('assets/images/teams/caroline.jpg') }}" alt="Caroline Achieng Oloo" class="team-avatar-img"></div><h3>Caroline Achieng Oloo</h3><div class="team-role">HR &amp; Administration Manager</div></div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="final-cta reveal">
      ...
      <div class="hero-actions">
        <a href="{{ route('public.jobs.index') }}" class="btn btn-primary">Work Abroad</a>
        <a href="{{ route('public.study-abroad.index') }}" class="btn btn-outline">Study Abroad</a>
        <a href="{{ route('public.hire') }}" class="btn btn-outline">Hire Talent</a>
      </div>
    </div>
  </div>
</section>
