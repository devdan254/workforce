<x-public-layout title="Job Application | Altura Workforce Solutions">
  ...
  <div class="container">
    <div class="form-card reveal" style="max-width:560px;margin:0 auto;text-align:center;">
      ...
      <p style="color:var(--color-ink-600);margin-bottom:24px;">
        Job applications are submitted through a Job Seeker profile. Your current account is a {{ $accountType }} account,
        so it can't be used to apply for jobs directly. Log out and create a Job Seeker profile, or contact us if you
