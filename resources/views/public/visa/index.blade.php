<x-public-layout title="Visa Support Services | Altura Workforce Solutions" :meta-description="'Professional visa guidance for work, student, tourist and business visas. Altura Workforce Solutions helps you prepare a complete and accurate application.'">
...
<section class="hero-banner" style="--hero-img:url('https://images.pexels.com/photos/4173219/pexels-photo-4173219.jpeg?auto=compress&cs=tinysrgb&w=1920');">
  <div class="container">
    <div class="breadcrumb"><a href="{{ route('public.home') }}">Home</a><i class="fa-solid fa-chevron-right" style="font-size:10px;"></i><span>Visa Support</span></div>
    ...
    <div class="hero-actions">
      ...
      <a href="{{ route('public.visa-application-form') }}" class="btn btn-outline">Start Your Visa Application</a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="services-grid reveal-stagger">
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.visa-application-form') }}" class="service-link">Apply for a Work Visa <i class="fa-solid fa-arrow-right"></i></a>
      </div>
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.visa-application-form') }}" class="service-link">Apply for a Student Visa <i class="fa-solid fa-arrow-right"></i></a>
      </div>
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.visa-application-form') }}" class="service-link">Apply for a Tourist Visa <i class="fa-solid fa-arrow-right"></i></a>
      </div>
      <div class="service-card card reveal">
        ...
        <a href="{{ route('public.visa-application-form') }}" class="service-link">Apply for a Business Visa <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="about-split" style="align-items:center;">
      ...
      <div class="form-card reveal">
        ...
        <form data-ajax-form action="{{ route('public.inquiries.visa-consultation') }}">
          @csrf
...
<section class="section bg-tint">
  <div class="container">
    <div class="final-cta reveal">
      ...
      <div class="hero-actions">
        <a href="{{ route('public.visa-application-form') }}" class="btn btn-primary">Start Your Visa Application</a>
        <a href="{{ route('public.contact') }}" class="btn btn-outline">Chat with Our Visa Consultant</a>
      </div>
    </div>
  </div>
</section>
