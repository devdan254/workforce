...
class StoreJobPostingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // employer_id deliberately not here — no Employer catalog exists
            // yet (Stage 3). The column is already nullable/unconstrained,
            // ready for that later without another migration.
        ];
    }
}
